        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">ویرایش وسیله</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form">
                ...
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/deviceController/checkEditDevice">
                    <div class="form-body">
                        <div class="form-group form-md-line-input <?php if (!empty($error_name)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" value="<?=$row->name;?>" placeholder="F18">
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_serial_no)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="serial_no" value="<?=$row->serial_no?>" placeholder="سریال نمبر وسیله">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_ip)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ip_addr" value="<?=$row->ip_addr?>" placeholder="x.x.x.x">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_port_no)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="port_no" value="<?=$row->port_no?>" placeholder="3370">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-2 col-md-10">
                                    <input type="hidden" name="deviceId" value="<?=$row->dev_id?>"/>
                                    <a href="<?=base_url()?>index.php/deviceController/index" class="btn default">لغو</a>
                                    <input type="submit" name="editDevice" class="btn blue" value="ذخیره"/>
                                </div>
                            </div>
                        </div>
                </form>
