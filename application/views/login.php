...
<html lang="en" dir="rtl">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Kabul Polytechnic university</title>
    ...
    <!-- END HEAD -->
    <body class="login" style="background:url(<?=base_url()?>assets/img/3.jpg) no-repeat top center fixed;background-size: cover;">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="<?=base_url()?>index.php/loginController/index">
                <img style="width:140px; margin-top:-30px; margin-bottom:-20px" src="<?= base_url()?>assets/img/logo.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
