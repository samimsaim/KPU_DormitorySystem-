        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">ویرایش کارمند</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/employeeController/checkEditEmp" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_father_name)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="father_name" value="<?=$row->father_name?>" placeholder="احمدی">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_grand_father_name)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="grand_father_name" value="<?=$row->grand_father_name?>" placeholder="ولی">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_position)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="position" value="<?=$row->position?>" placeholder="استاد بلاک">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_phone)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <input type="tel" class="form-control" name="phone" value="<?=$row->phone?>" placeholder="07xx xxx xxx">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_photo)) echo 'has-error' ?>">
                            <label class="col-md-2 control-label" style="font-weight: bold">عکس کارمند</label>
                            <div class="col-md-8">
                    ...
                    <input type="hidden" name="photo_path" value="<?=$row->photo?>">
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a href="<?=base_url()?>index.php/employeeController/index" class="btn default">لغو</a>
                                <input type="submit" name="editEmp" class="btn blue" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
