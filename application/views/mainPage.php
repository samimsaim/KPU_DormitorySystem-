                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet light portlet-fit ">
                                ...
                                <div class="col-md-6"  >
                                    <div style="text-align:right;  border-right: 15px solid #0000cc;margin-left:100px;font-weight: bolder" >&nbsp شاگردان حاضر در صبح : <?php echo($morningP);?></div>
                                    <br>
                                    <div style="text-align: right; margin-left:  100px;border-right: 15px solid #e600e6;font-weight: bolder">&nbsp شاگردان حاضر در چاشت : <?php echo($lunchP);?></div><br>
                                    <div style="text-align: right; margin-left:  100px;border-right: 15px solid #00ff80;font-weight: bolder">&nbsp شاگردان  حاضر در شب : <?php echo($nightP);?></div>
                                    <canvas id="student" height="370px" style="margin-right:50px ">
                                </div>
                                <div class=" col-md-6" >
                                   <div style="text-align:right;  border-right: 15px solid #cc0052;margin-left:100px;font-weight: bolder" >&nbsp  شاگردان غیر حاضر در صبح : <?php echo($noneP - $morningP);?></div>
                                   <br>
                                   <div style="text-align:right;  border-right: 15px solid #e62e00;margin-left:100px;font-weight: bolder" >&nbsp  شاگردان غیر حاضر در چاشت : <?php echo($noneP -$lunchP);?></div>
                                   <br>
                                    <div style="text-align: right; margin-left:  100px;border-right: 15px solid #00e6e6;font-weight: bolder">&nbsp شاگردان غیر حاضر در شب : <?php echo($noneP -$nightP);?></div>
        ...
        <script>
            $(document).ready(function(){
                var ctx = $("#student").get(0).getContext("2d");
                 var morningP = <?=$morningP?>;           
                 var lunchP=<?=$lunchP?>;
                 var nightP=<?=$nightP?>;
                 var sum=morningP+lunchP+nightP;
...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success:function(data){
            var morningP= data['morningP'];
            var lunchP=data['lunchP'];
            var nightP=data['nightP'];
          Highcharts.chart('container', {
    chart: {
        type: 'column'
    },
